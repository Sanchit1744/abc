...
# Label
cd_sec_ques_lbl = Label(cd_signup_window, text='Security Question', font=('Times New Roman', 20, 'bold'), bg='white', fg='firebrick1')
cd_sec_ques_lbl.place(x=127, y=315)

# create a combobox
selected_option = tk.StringVar()
cd_combobox = ttk.Combobox(cd_signup_window, textvariable=selected_option, values=cd_options, width=29, font=('Times New Roman', 20, 'bold'),state="readonly" )
