...
# Button
cd_login_btn = Button(cd_login_window, text='LOGIN', font=('Open Sans', 20, 'bold'), fg='white', bg='firebrick1', activeforeground='white', activebackground='firebrick1', cursor='hand2', bd=0, width=25, height=1, command = nextPagetoHome)
...
cd_new_acc_btn = Button(cd_login_window, text='Create One Now', font=('Open Sans', 15, 'bold underline'), fg='blue', bg='white', activeforeground='blue', activebackground='white', cursor='hand2', bd=0, command = nextPagetoSignUp)
